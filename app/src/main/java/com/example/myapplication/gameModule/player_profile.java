...
//        });
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(player_profile.this, login.class);
...
//        });
        ...
        final TextView playernName = (TextView) findViewById(R.id.pName);
        ...
        databaseReference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                profileRegistration userProfile = snapshot.getValue(profileRegistration.class);
                ...
                if(userProfile != null)
                {
                    ...
                    playernName.setText(playerName);
