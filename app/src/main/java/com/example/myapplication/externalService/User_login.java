...
//        }
        ...
        remember = findViewById(R.id.wrememberMe);
        ...
        signUp.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(User_login.this, User_signup.class);
...
//                    editor.apply();
//                    Toast.makeText(User_login.this, "Checked", Toast.LENGTH_SHORT).show();
//
//                }
...
//                    editor.apply();
//                    Toast.makeText(User_login.this, "Uncheked", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
    }
       ...
       mAuth.signInWithEmailAndPassword(_esEmail, _password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
           ...
           public void onComplete(@NonNull Task<AuthResult> task) {
               if(task.isSuccessful())
               {
                   ...
                   {
                       Intent intent = new Intent(getApplicationContext(), Import_chat.class);
